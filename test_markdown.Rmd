...
.layout-container {
    display: flex;
    flex-direction: row;
    justify-content: flex-start; /* Align the graphs to the left */
    gap: 20px; /* Adjust space between graphs */
}

.graph-container {
    flex: 1;
    margin: 0 5px; /* Adjust margin as needed */
    width: 35%; /* Adjust width of each graph container */
}
</style>
"

# Create div layout with custom CSS
layout <- tags$div(
    class = "layout-container",
    tags$div(class = "graph-container", p1),
    tags$div(class = "graph-container", p2),
    tags$div(class = "graph-container", p3),
    HTML(custom_css)
)
...
#layout2 <- div(style = "display: flex; flex-direction: row;",p1,p2,p3)
