...
##Small spatial
##################
taxa<- c("Be", "Fi", "Al", "In", "Ma", "Mo","Mu","Ot","Plankton","Pplankton")
...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      uiOutput("selected_taxa"),
      div(actionButton("add_plot", "See the plot"), 
          actionButton("clear", "Clear All")
          )
    ),
    
    mainPanel(chorddiag::chorddiagOutput("chordDiagram"),
    )
  )
)
...
server <- function(input, output, session) {
  ...
  observeEvent(input$add_plot, {
     output$chordDiagram <- renderChorddiag({ chorddiag::chorddiag(mydata(), groupColors = use_cols(), showGroupnames = FALSE, groupPadding = 2,showTooltips = TRUE,precision=3, showZeroTooltips = FALSE,tickInterval=10,ticklabelFontsize=0,groupnamePadding = 0,width = 350, height=350, margin=10)
     })
  })
